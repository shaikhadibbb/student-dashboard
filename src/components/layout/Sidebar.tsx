...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      {/* Nav items — ELEGANT, NOT OVERSIZED */}
        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={cn(
                "relative flex items-center w-full px-4 py-3 rounded-xl text-base font-medium transition-all duration-200",
                isActive
                  ? "text-white"
            ...
            >
              {isActive && (
                <motion.div
                  layoutId="activeNav"
                  className="absolute inset-0 bg-[#16161f] rounded-xl border border-[#6366f1]/20"
