...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      {/* Collapse button at BOTTOM — FIXED */}
      <div className="mt-auto p-4 border-t border-white/[0.04]">
        <button
          onClick={() => setCollapsed(!collapsed)}
          className="flex items-center gap-3 text-gray-500 hover:text-white text-sm transition-colors w-full px-3 py-2.5 rounded-lg hover:bg-white/[0.02]"
        >
          {/* PanelLeft icon as SVG */}
          <svg 
